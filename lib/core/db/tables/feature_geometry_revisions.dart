...
class FeatureGeometryRevisions extends Table {
  ...
  TextColumn get operation => text().withDefault(const Constant('reshape'))();
  TextColumn get relatedFeatureId => text().nullable()();
  TextColumn get relatedGeojson => text().nullable()();
